...
import streamlit as st
from authentification_drive import download_file

# Fonction pour télécharger les fichiers depuis Google Drive
def download_drive_files():
    # ID des fichiers Google Drive
    file_id_1 = '1_0feUsaKHhuFCUCfwOkC7TwXJY3g5cSn'  # Remplace par l'ID réel
    file_id_2 = '1KX2kOheM7yC6-BnOX8Mgp53SwTndTMms'  # Remplace par l'ID réel

    # Télécharger les fichiers
    download_file(file_id_1, 'comptage-velo-donnees-compteurs.csv')
    download_file(file_id_2, 'comptage-velo-CLEAN.csv')
...
# Télécharger les fichiers depuis Google Drive avant de les charger
